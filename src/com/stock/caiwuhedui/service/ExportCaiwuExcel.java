...
public class ExportCaiwuExcel {
	...
	public void exportYHRiJiExcel(String title, List<List<String>> listData, OutputStream out, String pattern) {
        // 声明一个工作薄
...
//        收视费
        ...
        sheet.addMergedRegion(new CellRangeAddress(size - 2, size - 2, 4, 9));
        sheet.addMergedRegion(new CellRangeAddress(size - 2, size - 2, 10, 11));
        sheet.addMergedRegion(new CellRangeAddress(size - 2, size - 2, 12, 16));
        sheet.addMergedRegion(new CellRangeAddress(size - 2, size - 2, 17, 26));
