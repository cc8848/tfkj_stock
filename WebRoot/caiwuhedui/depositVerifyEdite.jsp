...
<html  xmlns="http://www.w3.org/1999/xhtml">
	...
	<div style="height:440px;">
		<html:form action="depositVerifyList.do">
		...
		<bean:define id="senList" name="zhangmuForm" property="senList"></bean:define>
			<div id="content_all">
				...
				<div id="conten_query2">
					<table id="quert_table2"  align="center" cellpadding="1" cellspacing="1" border="1">
						<tr  align="center">
							<td width="60px">
					...
					<table id="quert_table2"  align="center" cellpadding="1" cellspacing="1" border="1">
						<tr  align="center">
							...
							<td>
								<html:select name="zhangmuForm" property="hedui"
								styleClass="commonTextFieldHover" 
								onfocus="this.className='commonTextFieldMove'" 
								onblur="this.className='commonTextFieldHover'">
								<html:option value="">-请选择-</html:option>
								<html:option value="已核对">已核对</html:option>
								<html:option value="未核对">未核对</html:option>
								</html:select>
							</td>
							<td align="right">
								<input type="button" value="查询" class="commonButton" onclick="commonSubmit('depositVerifyList.do?act=query')" />
							</td>
							<td width="60px">
							...
							<td width="100px">
								<font style="font-weight: bold;">已核对信息数量:</font>
							</td>
							<td>
								<html:text name="zhangmuForm" property="yihedui" readonly="true" size="6"/>
							</td>
							<td width="180px">
								<font style="font-weight: bold;">总金额与已核对金额的差值:</font>
							</td>
							<td>
				...
				<div id="buttonC" name="button" class="content_button" >
				   <html:button property="btnSave" value="保存" styleClass="commonButton" onclick="commonCheckSubmit('zhangMuEdit.do?act=insertShenheZhangmu','UUIDS','请选要审核的数据')"/>
				 <!--   <html:button property="btnSave" value="删除" styleClass="commonButton" onclick="removeData2();"/> -->
				  <html:button property="btnSave" value="返回" styleClass="commonButton" onclick="commonSubmit('financingcheckList.do?act=reback&zhuangtai=1')"/>
			    </div>
			</div>
			<html:hidden name="zhangmuForm" property="zmUUIDHidden" />
			...
			<html:hidden name="zhangmuForm" property="zmidHidden" />
