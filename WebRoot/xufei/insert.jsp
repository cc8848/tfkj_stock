		...
		<script type="text/javascript">
			...
			$().ready(function() {
				...
				var wangluo = "";
					...
					function initnoyouhui() {
						document.forms[0].beishutype[3].checked=true;
					}
					function getyouhui(money) {
						if(document.forms[0].beishutype[0].checked) {
							return 999999999;
						}else if(document.forms[0].beishutype[1].checked){
							return money*0.8;
						}else if(document.forms[0].beishutype[2].checked){
							return 0;
						}
						return money;
					}
...
<jsp:include page="/common/commonMessage.jsp" />
	...
	<body onload="init();initnoyouhui();" id="body1">  
		...
		<div id="content_all">
			...
			<div name="result" class="conten_result">
				...
				<table border="0" cellspacing="0" cellpadding="2" width="960px">
					...
					<tr>
						...
						<td class="editTableContent">
							资费调整倍数：
								<html:select name="jiaofeiDataFrom"  styleId="beishuselect" property="beishuselect" styleClass="commonTextFieldHover"   onfocus="this.className='commonTextFieldMove'" onblur="this.className='commonTextFieldHover'" onchange="changeshijian();beishuchange();">
								...
								<html:radio name="jiaofeiDataFrom" styleId="beishutype" property="beishutype" value="1" onclick="beishuchange();">升级或特殊资费</html:radio>
								<html:radio name="jiaofeiDataFrom" styleId="beishutype" property="beishutype" value="2" onclick="beishuchange();">八折</html:radio>
								<html:radio name="jiaofeiDataFrom" styleId="beishutype" property="beishutype" value="3" onclick="beishuchange();">特批免费</html:radio>
								<html:radio name="jiaofeiDataFrom" styleId="beishutype" property="beishutype" value="0" onclick="beishuchange();">无优惠</html:radio>
						</td>
					</tr>
					...
					<tr >
						...
						业务开机时间：
						 <html:text name="jiaofeiDataFrom" property="kaijishijian" styleId="kaijishijians" size="10" onclick="WdatePicker({el:'kaijishijians'})" onchange="changeshijian()"/>
						...
						<img onclick="WdatePicker({el:'tingjishijians'})" src="${pageContext.request.contextPath}/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle"/> 
						 <a:need /><br />
						收款时间： 
					...
					<tr>
						...
						<td class="editTableContent" >
							...
							收视费：
							<html:text name="jiaofeiDataFrom" property="shoushifei" maxlength="50" readonly="true"  value="0"
								styleClass="commonTextFieldHover" 
								onfocus="this.className='commonTextFieldMove'" 
								onblur="this.className='commonTextFieldHover'"  />
							<br/>
			...
			<div name="button" class="content_button">
				...
				<html:button property="btnBack" value="返回" styleClass="commonButton" onclick="commonSubmit('daijiaofeiDataList.do?act=init')"/> 
			</div>
		</div>
