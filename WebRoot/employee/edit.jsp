...
<html>
	...
	<body onload="init()">
		<html:form action="employeeEdit.do">
		<div id="content_all">
			<!-- 标题 -->
				...
				<table border="0" cellspacing="0" cellpadding="2" width="960px">
					<tr height="35px">
						...
						<td class="editTableContent">
							<span><bean:write name="employeeForm" property="employeeCode"/></span>
						</td>
					<tr>
					<tr height="35px">
			...
			<div name="button" class="content_button">
				<html:button property="btnSave" value="保存" styleClass="commonButton" onclick="commonSubmit('employeeEdit.do?act=update')"/>
				<html:button property="btnBack" value="返回" styleClass="commonButton" onclick="commonSubmit('employeeList.do?act=init')"/>
			</div>
		</div>
		<html:hidden name="employeeForm" property="employeeCode" />
		</html:form>
	</body>
</html>