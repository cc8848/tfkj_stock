		...
		<bean:define id="quyuList" name="yuyueForm" property="quyuList"></bean:define>
			<div id="content_all">
				...
				<div id="conten_query">
					<table id="quert_table" cellpadding="1" cellspacing="1" border="0">
						<tr>
							...
							<td align="right">
								<input type="button" value="查询" class="commonButton" onclick="commonSubmit('yuyueList.do?act=query')" />
							</td>
						</tr>
					</table>
				...
				<div name="button" class="content_button">
					...
					<html:button property="btnSave" value="冻结计划" styleClass="commonButton2" onclick="removeData2()"/>
				</div>
			</div>
