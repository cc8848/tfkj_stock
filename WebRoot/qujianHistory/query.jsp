...
<html  xmlns="http://www.w3.org/1999/xhtml">
	...
	<div style="height:440px;">
		<html:form action="qujianHistoryList.do">
		<bean:define id="xiaoquList" name="qujianHistoryForm" property="xiaoquList"></bean:define>
			<div id="content_all">
				<!-- 标题 -->
				...
				<div id="conten_query">
					<table id="quert_table" cellpadding="1" cellspacing="1" border="0">
						<tr>
							...
							<td>
								<html:text name="qujianHistoryForm" property="paigongriqis" styleId="paigongriqis" size="12" onclick="WdatePicker({el:'paigongriqis'})" />
							...
							<td>
								<html:select name="qujianHistoryForm" property="xiangmus"
							...
							<td>
								<html:select name="qujianHistoryForm" property="xiaoqu"
								styleClass="commonTextFieldHover" 
								onfocus="this.className='commonTextFieldMove'" 
								onblur="this.className='commonTextFieldHover'">
								<html:option value="">--请选择--</html:option>
							...
							<td>
								<html:text name="qujianHistoryForm" property="userplaces" size="12" />
							</td>
							<td>
								联系电话：
							</td>
							<td>
								<html:text name="qujianHistoryForm" property="userTel" size="12" />
							</td>
						<!-- 	<td>
								派工单状态：
							</td>
							<td>
							<html:select name="qujianHistoryForm" property="state"
								styleClass="commonTextFieldHover" 
								onfocus="this.className='commonTextFieldMove'" 
								onblur="this.className='commonTextFieldHover'">
								<html:option value="">--请选择--</html:option>
							...
							<td align="right">
								<input type="button" value="查询" class="commonButton" onclick="commonSubmit('qujianHistoryList.do?act=query')" />
							</td>
						</tr>
					</table>
				...
				<div name="result" class="conten_result">
					...
					<div name="result_table" class="result_table">
						<table border="0" cellspacing="0" cellpadding="1" width="210%">
							...
							<logic:iterate id="line"
								...
								<tr align="center">
									...
									<td class="tableContentLine">
										<bean:write name="line" field="qujianby" />
									</td>
									<td class="tableContentLine">
										<bean:write name="line" field="qujiandt" />
									</td>
									<td class="tableContentLine">
										<bean:write name="line" field="yiqujianby" />
									</td>
									<td class="tableContentLine">
										<bean:write name="line" field="yiqujiandt" />
									</td>
									<td class="tableContentLine">
										<bean:write name="line" field="yishangchuanby" />
									</td>
									<td class="tableContentLine">
										<bean:write name="line" field="yishangchuandt" />
									</td>
									<td class="tableContentLine">
										<bean:write name="line" field="ysdxxdby" />
									</td>
									<td class="tableContentLine">
										<bean:write name="line" field="ysdxxddt" />
									</td>
									<td class="tableContentLine">
										<bean:write name="line" field="sckfsjby" />
									</td>
									<td class="tableContentLine">
										<bean:write name="line" field="sckfsjdt" />
									</td>
									<td class="tableContentLine">
			...
			<html:hidden name="qujianHistoryForm" property="stateDateHidden" />
			<html:hidden name="qujianHistoryForm" property="endDateHidden" />
			<html:hidden name="qujianHistoryForm" property="xiaoquHidden" />
			<html:hidden name="qujianHistoryForm" property="userTelHidden" />
			<html:hidden name="qujianHistoryForm" property="stateHidden" />
			<html:hidden name="qujianHistoryForm" property="paigongriqisHidden" />
			<html:hidden name="qujianHistoryForm" property="xiangmusHidden" />
		</html:form>
		</div>
