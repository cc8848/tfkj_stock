...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="init()">
		<html:form action="shuliangtotalList.do" method="post">
			<div id="content_all">
				<!-- 标题 -->
...
function exportNoBind(){
	document.forms[0].action = 'shuliangtotalListDaochu.do?act=query';
 	document.forms[0].submit();
}			
function sub() {
	if (checkInput()) {
		commonSubmit('shuliangtotalList.do?act=query');
	}
}
