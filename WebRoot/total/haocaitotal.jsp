...
<html  xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="init()">
		<html:form action="haocaitotalList.do" >
					 ...
					 <bean:define id="pathA" name="totalForm" property="pathA"></bean:define>
						...
						<logic:iterate id="line"
								...
								<tr align="center">
									...
									<td class="tableTitleLine"nowrap="nowrap">
										<bean:write name="line" field="jiexianziNum" /> 
									</td >
									<td class="tableTitleLine"nowrap="nowrap">
										<bean:write name="line" field="rj11Num" /> 
									</td >
									<td class="tableTitleLine"nowrap="nowrap">
										<bean:write name="line" field="rj45Num" /> 
									</td >
									<td class="tableTitleLine"nowrap="nowrap">
										<bean:write name="line" field="mokuaiNum" /> 
									</td >
									<td class="tableTitleLine"nowrap="nowrap">
										<bean:write name="line" field="mianbanNum" /> 
									</td >
									<td class="tableTitleLine"nowrap="nowrap">
										<bean:write name="line" field="wangxianNum" /> 
									</td >
	...
	function sub(){
			if(checkInput())
				{
					commonSubmit('haocaitotalList.do?act=query');
				}
			}
