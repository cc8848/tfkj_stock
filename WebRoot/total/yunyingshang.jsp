...
<html  xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="init()">
		<html:form action="serchYunYingShangList.do" >
...
<!-- 				  		 <html:button property="btnSave" value="导出数据" styleClass="commonButton3" onclick="commonCheckSubmit('serchSheQuJineList.do?act=shequjineimport','UUID','请选择待编辑的用户数据')"/> -->
			    		 <html:button property="btnSave" value="导出数据" styleClass="commonButton3" onclick="commonSubmit('serchYunYingShangList.do?act=yunYingShangDataImport')"/>
			    	</div>
					<!-- 结果一览 end-->
	...
	function sub(){
					...
					commonSubmit('serchYunYingShangList.do?act=query');
