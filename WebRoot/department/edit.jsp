...
<html>
	<head>
		...
		<script src="js/keyCode13.js" language="javascript"></script>
		...
		<div id="content_all">
			...
			<div name="result" class="conten_result">
				...
				<table border="0" cellspacing="0" cellpadding="2" width="960px">
					<tr height="35px">
						<td class="editTableTitle">部门代码：</td>
						<td class="editTableContent">
							<span><bean:write name = "departmentForm" property="departmentCode"/></span>
						</td>
					<tr>
					<tr height="35px">
			...
			<div name="button" class="content_button">
				<html:button property="btnSave" value="保存" styleClass="commonButton" onclick="commonSubmit('departmentEdit.do?act=update')"/>
				<html:button property="btnBack" value="返回" styleClass="commonButton" onclick="commonSubmit('departmentList.do?act=init')"/>
			</div>
		</div>
		<html:hidden name="departmentForm" property="departmentCode" />
		</html:form>
	</body>
</html>