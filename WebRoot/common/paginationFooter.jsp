	...
	<td align="right">
        <span id="paginationButtonGroup" >
	        ...
	        <logic:equal name="com.takucin.aceeci.frame.pagination" property="renderedpreviousStatus" value="true">
				<a href="javascript:doPaginationSubmit('firstPage')">首页</a> 
				<a href="javascript:doPaginationSubmit('previous')">上一页</a> 
			</logic:equal>
			...
			<logic:equal name="com.takucin.aceeci.frame.pagination" property="renderedNextStatus" value="true">
				<a href="javascript:doPaginationSubmit('next')">下一页</a> 
				<a href="javascript:doPaginationSubmit('lastPage')">尾页</a>
			</logic:equal>
