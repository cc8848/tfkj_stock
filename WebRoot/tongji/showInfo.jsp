			...
			<div name="result" class="conten_result">
				...
				<table border="0" cellspacing="0" cellpadding="2" width="940px">
					...
					<tr height="35px">
						...
						时长	：
					<!-- 	<html:select name="paiGongDanEntiyForm" property="tfkdnianxian" 
								styleClass="commonTextFieldHover" styleId="tfkdnianxian"disabled="true"
								onfocus="this.className='commonTextFieldMove'"  onchange="tfscselect(this);"
								onblur="this.className='commonTextFieldHover'">
								<html:option value="0"></html:option>
								<html:option value="天房宽带2M包月100元:fwt9039">天房宽带2M包月100元:fwt9039</html:option>
								<html:option value="天房宽带2M包月80元:fwt9002">天房宽带2M包月80元:fwt9002</html:option>
								<html:option value="天房宽带2M包15个月700元:fwt9009">天房宽带2M包15个月700元:fwt9009</html:option>
								<html:option value="天房宽带4M包月100元:fwt9012">天房宽带4M包月100元:fwt9012</html:option>
								<html:option value="天房宽带4M包15个月1000元:fwt9042">天房宽带4M包15个月1000元:fwt9042</html:option>
								<html:option value="天房宽带4M包月160元:fwt9043">天房宽带4M包月160元:fwt9043</html:option>
								<html:option value="天房宽带6M包月180元:fwt9021">天房宽带6M包月180元:fwt9021</html:option>
								<html:option value="天房宽带6M包15个月1400元:fwt9048">天房宽带6M包15个月1400元:fwt9048</html:option>
								<html:option value="天房宽带10M包月240元:fwt9047">天房宽带10M包月240元:fwt9047</html:option>
								<html:option value="天房宽带10M包15个月1800元:fwt9045">天房宽带10M包15个月1800元:fwt9045</html:option>
								<html:option value="天房宽带10M包月350元:fwt9046">天房宽带10M包月350元:fwt9046</html:option>
							</html:select>	 -->
					...
					<tr height="35px">
						...
						<html:select name="paiGongDanEntiyForm" property="tfiptvnianxian" disabled="true"
								styleClass="commonTextFieldHover"  styleId="tfiptvshichang" onchange="ipshichangchange(this);"
								onfocus="this.className='commonTextFieldMove'"  
								onblur="this.className='commonTextFieldHover'">
								<html:option value="0">--请选择--</html:option>
						...
						<td>
						运营商：
							<html:select name="paiGongDanEntiyForm" property="yuyingshang" disabled="true"
