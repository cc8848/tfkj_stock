...
<html>
	...
	<body onload="init()">
		...
		<div id="content_all">
			...
			<div name="result" class="conten_result">
				...
				<table border="0" cellspacing="0" cellpadding="2" width="940px">
						...
						<td class="editTableContentLast" >
							<html:textarea name="chugongdanEditForm" property="jiedanbeizhu"  styleId="jiedanbeizhu"
			...
			<div name="button" class="content_button">
				<html:button property="btnSave" value="确认结单" styleClass="commonButton2" onclick="sub()"/>
	...
	sub = function(){
		var beizhu =  document.getElementById("jiedanbeizhu").value;
		//alert(beizhu);
		if(beizhu==null||trim(beizhu)==""){
				alert("请输入备注内容！");
				return false;
			}
		commonSubmit('tongjiEdit.do?act=jiedan');
			}
	</script>
</html>