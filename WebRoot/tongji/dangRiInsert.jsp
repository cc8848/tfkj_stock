		...
		function backtodept() {
			...
			//$.ajax({
				...
				//success: function(data){
					//if(data == '0') {
						alert("设备回库成功！");
						document.getElementById("selectCommunityPileID").value = "";
						document.getElementById("selectCommunityPileID2").value = "";
...
function initKaijishijian() {
	...
	<body onload="init();initanzhuang();initFenguang();initAllFalse();initKaijishijian();">  
		...
		<div id="content_all">
			...
			<div name="result" class="conten_result">
				...
				<tr height="35px">
					...
					<tr height="35px">
						<td class="editTableTitle" width="30px" rowSpan="2">移机&切改：</td>
					...
					<tr >
						...
						号码1&nbsp;
							<html:text name="paiGongDanEntiyForm" property="telhaoma1" size="12"maxlength="20"
								styleClass="commonTextFieldHover" value="00000000"
								onfocus="this.className='commonTextFieldMove'" 
								onblur="this.className='commonTextFieldHover'" />
						</td>
						<td>		
	...
	callBackCardNo1 = function(data){
		if(data=="N"){
			commonSubmit('paigongdanEdit.do?act=insertDangRi');
		}else{
