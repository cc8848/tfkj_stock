...
<html  xmlns="http://www.w3.org/1999/xhtml">
	...
	<div style="height:440px;">
		<html:form action="jiaofeiTXYunweiList.do">
				...
				<div id="conten_query">
					<table id="quert_table" cellpadding="1" cellspacing="1" border="0">
						<tr>
							...
							<td>
								<html:text name="yonghuDataForm" property="addressCode" size="12" onkeydown="autoSubimit()"/>
							</td>
							<td>
								<font color='#FF0000'>* &nbsp;</font> 
							</td>
							...
							<logic:iterate id="line"
								...
								<tr align="center">
									<td class="tableContentLine" nowrap="nowrap">
										...
										<!-- <input name="UUID" type="radio" value="${line.id}" /> onclick="checkAll(this,'checkBox');"-->
									</td>
									<td class="tableContentLine" nowrap="nowrap">
		...
		<!-- 
			<html:form action="jiaoFeidataUpload.do?act=yunWeiUploadJiaoFei" method="post" enctype="multipart/form-data" >
				<table id="quert_table" cellpadding="1" cellspacing="1" border="0">
					<tr>
						<td>缴费上传：</td>
	  ...
	  function sub(){
			if(checkInput())
				{
					commonSubmit('jiaofeiTXYunweiList.do?act=query');
				}
			}
		...
		checkInput = function()
		{
			...
			var tingjidate = document.forms[0].tingjiDate.value;
			if(tingjidate==null||trim(tingjidate)=="")
				{
					alert("日期不能为空！");
					document.forms[0].tingjiDate.focus();//设置焦点
					return false;
				}
				return true;
		 } ;
