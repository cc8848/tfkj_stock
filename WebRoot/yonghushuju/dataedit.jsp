						...
						<tr height="35px">
							...
							<td class="editTableContent">
									...
									<tr>
										<td>用户状态： <html:select name="yonghuDataEntityForm" property="yonghuzhuangtai" 
										    ...
										    匹配状态： <html:select name="yonghuDataEntityForm" property="pipeizhuangtai" 
												...
												收款时间： <html:text name="yonghuDataEntityForm" property="shoukuanshijian" styleId="shoukuanshijian" size="10" onclick="WdatePicker({el:'shoukuanshijian'})" />
								...
								<img onclick="WdatePicker({el:'tingjishijians'})" src="${pageContext.request.contextPath}/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">  <a:need />
											有效时间： <html:text name="yonghuDataEntityForm" property="youxiaoshijian" styleId="youxiaoshijians" size="10" onclick="WdatePicker({el:'youxiaoshijians'})" />
								<img onclick="WdatePicker({el:'youxiaoshijians'})" src="${pageContext.request.contextPath}/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">  <a:need />
										</td>
									</tr>
									<tr>
...
<script type="text/javascript">
	function subs() {
		if (checkInput()) {
			commonSubmit('yonghuDataEdit.do?act=updateData');
		}
	}
</script>
</html>