					...
					<table border="0" cellspacing="0" cellpadding="2" width="940px">
						...
						<tr height="35px">
							...
							<td class="editTableContent">
								<table>
									<tr>
										<td>上门时间：<html:text name="yonghuDataEntityForm" disabled="true"
									...
									<tr>
										<td>设备销售费： <html:text name="yonghuDataEntityForm" disabled="true"
									...
									<tr>
										<td>备注： <!--  <html:text name="yonghuDataEntityForm"
												...
												onfocus="this.className='commonTextFieldMove'"
												onblur="this.className='commonTextFieldHover'" /> -->
											<html:textarea name="yonghuDataEntityForm" property="beizhu"   disabled="true"
									...
									<tr>
										<td>
											其他设备使用情况： <html:text name="yonghuDataEntityForm" disabled="true"
									...
									<tr>
										<td>其他耗材： <html:text name="yonghuDataEntityForm" disabled="true"
...
<script type="text/javascript"  language="javascript">
		function  back() {
			...
			switch (roleCode) {         
			        case '5': 
			            commonSubmit('yonghuDataList.do?act=init');
			 			break;               
			    	 case '4':               
			            commonSubmit('yonghuDataYunweiList.do?act=init');
			            break;       
			} 
		}
