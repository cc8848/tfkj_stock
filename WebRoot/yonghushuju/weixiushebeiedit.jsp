	...
	<html:form action="yonghuDataEdit.do">
		<div id="content_all">
			...
			<div name="button" class="content_button">
				...
				<html:button property="btnBack" value="返回" styleClass="commonButton" onclick="commonSubmit('weixiuDataList.do?act=init')" />
			</div>
		</div>
...
<script type="text/javascript">
	function subs() {
		if (checkInput()) {
			commonSubmit('weixiuDataEdit.do?act=updateShebeiData');
		}
	}
</script>
</html>