...
<html  xmlns="http://www.w3.org/1999/xhtml">
	...
	<div style="height:440px;">
		<html:form action="weixiuDataYunweiList.do">
		...
		<bean:define id="statusList" name="yonghuDataForm" property="statusList"></bean:define>
			<div id="content_all">
				...
				<div id="conten_query">
					<table id="quert_table" cellpadding="1" cellspacing="1" border="0">
						<tr>
							...
							<td>
								<html:text name="yonghuDataForm" 
								 property="addressCode" size="12"
								 onkeydown="autoSubimit()"/>
							</td>
							<td>
								<font color='#FF0000'>*  &nbsp;&nbsp;</font> 
							</td>
				...
				<div id="buttonC" name="button" class="content_button" ><%--
				  ...
				  <html:button property="btnSave" value="编辑ONU" styleClass="commonButton2" onclick="commonCheckSubmit('yonghuDataEdit.do?act=initOnuEdit','UUID','请选择待编辑的用户数据')"/>
				  <html:button property="btnSave" value="编辑MCID" styleClass="commonButton2" onclick="commonCheckSubmit('yonghuDataEdit.do?act=initMcidEdit','UUID','请选择待编辑的用户数据')"/>
				  --%><html:button property="btnSave" value="查看详情" styleClass="commonButton2" onclick="commonCheckSubmit('weixiuDataEdit.do?act=showInfo','UUID','请选择待查看的用户数据')"/>
		...
		<!-- 
			<html:form action="weiXiudataUpload.do?act=yunWeiUploadWeixiu" method="post" enctype="multipart/form-data" >
				<table id="quert_table" cellpadding="1" cellspacing="1" border="0">
					<tr>
						<td>维修数据上传：</td>
	...
	<%-- 	function  hiddenEditDiv() {
		...
		function sub(){
			if(checkInput())
				{
					commonSubmit('weixiuDataYunweiList.do?act=query');
				}
			}
