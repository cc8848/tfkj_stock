...
<html>
		...
		<div id="content_all">
			...
			<div name="result" class="conten_result">
				...
				<table border="0" cellspacing="0" cellpadding="2" width="960px">
					<tr >
						<td class="editTableTitleLast" >异常库存转移：</td>
						<td class="editTableContentLast">
						设备状态:
						<html:select name="kucunForm" property="shebeizhuangtai"
			...
			<div name="button" class="content_button">
				<html:button property="btnSave" value="确定" styleClass="commonButton" onclick="commonSubmit('shebeiyichangkuList.do?act=kucunToyichangku')"/>
	...
	<script type="text/javascript">
		function sub() {
			if(checkInput()) {
				commonSubmit('shebeiyichangkuList.do?act=kucunToyichangku');
			}
		}
		/* checkInput = function() {
