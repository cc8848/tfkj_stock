						...
						<tr>
							...
							<td>
								<html:select name="kucunForm" property="shijianleixing" onclick="check(this)"
									...
									<html:option value="3">安装日期</html:option>
								</html:select>
							</td>
							<td>
								开始时间：
							...
							<td>
<!-- 								<input type="button" value="查询" class="commonButton" onclick="commonSubmit('shebeiyichangkuList.do?act=query')" /> -->
								<input type="button" value="查询" class="commonButton" onclick="if(check()){commonSubmit('shebeiyichangkuList.do?act=query');}" />
							</td>
							<td >
				...
				<div id="buttonC" name="button" class="content_button" >
					...
					<html:button property="btnSave" value="编辑" styleClass="commonButton" onclick="commonCheckSubmit('shebeiyichangkuList.do?act=shebeiEdit&zhuangtai=3','UUID','请选择要编辑的设备！')"/>
					<html:button property="btnSave" value="状态变更" styleClass="commonButton2" onclick="commonCheckSubmit('shebeichuku.do?act=shebeiZTchange&zhuangtai=3','UUIDS','请选择要变更状态的设备！')"/>	
			    	<html:button property="btnSave" value="设备历史信息" styleClass="commonButton4" onclick="commonCheckSubmit('shebeixinxi.do?act=init&zhuangtai=3','UUID','请选择要查寻的设备！')"/>
			    	<html:button property="btnSave" value="设备移库" styleClass="commonButton3" onclick="commonCheckSubmit('shebeichuku.do?act=shebeichuku&zhuangtai=3','UUIDS','请选择要移库的设备！')"/>
			    </div>
			</div>
