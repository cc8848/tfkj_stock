		...
		<bean:define id="xiaoquList" name="kucunForm" property="xiaoquList"></bean:define>
			<div id="content_all">
				...
				<div id="conten_query2">
					<table id="quert_table" cellpadding="1" cellspacing="1" border="0">
						...
						<tr>
							...
							<td>
								<!-- <input type="button" value="查询" class="commonButton" onclick="commonSubmit('shebeianzhuangkuList.do?act=query')" /> -->
								  <input type="button" value="查询" class="commonButton" onclick="if(check()){commonSubmit('shebeianzhuangkuList.do?act=query');}" />
							</td>
							<td >
				...
				<div id="buttonC" name="button" class="content_button" >
					...
					<html:button property="btnSave" value="编辑" styleClass="commonButton" onclick="commonCheckSubmit('shebeianzhuangkuList.do?act=shebeiEdit','UUID','请选择要编辑的设备！')"/>
					<html:button property="btnSave" value="状态变更" styleClass="commonButton2" onclick="commonCheckSubmit('shebeichuku.do?act=shebeiZTchange&zhuangtai=2','UUIDS','请选择要变更状态的设备！')"/>
					<html:button property="btnSave" value="设备历史信息" styleClass="commonButton4" onclick="commonCheckSubmit('shebeixinxi.do?act=init&zhuangtai=2','UUID','请选择要查寻的设备！')"/>
			    </div>
			</div>
