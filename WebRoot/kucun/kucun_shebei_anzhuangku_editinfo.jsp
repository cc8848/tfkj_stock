	...
	<bean:define id="userNameList" name="kucunForm" property="userNameList"></bean:define>
		<div id="content_all">
			...
			<div name="button" class="content_button">
				...
				<html:button property="btnBack" value="返回" styleClass="commonButton" onclick="switchBackPage()" />
			</div>
		</div>
...
<script language="javascript" type="text/javascript">
	function sub_updateProduct() {
		if(checkInput()){
			switchPage();
			//commonSubmit('shebeiEdite.do?act=update_AnzhuangKu');
		}
	}
 	checkInput = function() {
		...
		if (zhuangtai == 3){
			commonSubmit('shebeiEdite.do?act=update_AnzhuangKu&zhuangtai=3');
		} else {
			commonSubmit('shebeiEdite.do?act=update_AnzhuangKu&zhuangtai=2');
		}
	}
	 function switchBackPage(){
		var zhuangtai = document.getElementById("zhuangtai").value;
		if (zhuangtai == 3){
