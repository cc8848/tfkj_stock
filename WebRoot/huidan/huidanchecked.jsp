		...
		<bean:define id="statusList" name="HuidanForm" property="statusList"></bean:define>
			...
			<div id="content_all">
				...
				<div id="conten_query2">
					<table id="quert_table" cellpadding="1" cellspacing="1" border="0">
						...
						<!-- 	<td>
								...
								<td><input type="button" value="查询" class="commonButton" onclick="if(check2()){commonSubmit('huidancheckedList.do?act=query');}" /></td>
						</tr>
					</table>
				...
				<div id="buttonC" name="button" class="content_button" >
					<html:button property="btnSave" value="查看详情" styleClass="commonButton2" onclick="commonCheckSubmit('huidanDataEdit.do?act=showInfo&zhuangtai=1','UUID','请单选择待查看的数据')"/>
					<html:button property="btnSave" value="核对备注" styleClass="commonButton2" onclick="commonCheckSubmit('huidancheckedList.do?act=heduiBeizhu','UUID','请单选择待核对备注的数据')"/>
					<html:button property="btnSave" value="核对提交" styleClass="commonButton2" onclick="commonCheckSubmit('huidancheckedList.do?act=tijiaoHedui','UUIDS','请多选择待提交的数据')"/>
			    </div>
			</div>
