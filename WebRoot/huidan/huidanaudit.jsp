...
<html  xmlns="http://www.w3.org/1999/xhtml">
	...
	<div style="height:440px;">
		<html:form action="huidanauditList.do">
		...
		<bean:define id="statusList" name="HuidanForm" property="statusList"></bean:define>
			...
			<div id="content_all">
				...
				<div id="buttonC" name="button" class="content_button" >
					<html:button property="btnSave" value="核对提交" styleClass="commonButton2" onclick="commonCheckSubmit('huidanauditList.do?act=tijiaoHedui','UUIDS','请多选择待提交的数据')"/>
			    </div>
			</div>
