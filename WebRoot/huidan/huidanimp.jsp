		...
		<html:form action="huidandaoruList.do">
			...
			<div id="content_all">
				...
				<div id="conten_query2">
					<table id="quert_table" cellpadding="1" cellspacing="1" border="0">
						<tr>
							...
							<td>
								<html:select name="HuidanForm" property="xiaoqu_cha"
							...
							<td>
								<input type="button" value="查询" class="" onclick="if(check()){commonSubmit('huidandaoruList.do?act=query');}" />
							</td>
						</tr>
					</table>
				...
				<div id="buttonC" name="button" class="content_button" >
					<html:button property="btnSave" value="全选" styleClass="commonButton" onclick="check_()"/>
					<html:button property="btnSave" value="删除(多选)" styleClass="commonButton2" onclick="commonCheckSubmit('huidandaoruList.do?act=huidanDelete','UUIDS','请选择要删除的回单！')"/>
			    	<html:button property="btnSave" value="查询详情" styleClass="commonButton2" onclick="commonCheckSubmit('huidandaoruList.do?act=huidanLook','UUID','请选择要查询的回单')" />
			    	<html:button property="btnSave" value="电子单下发" styleClass="commonButton4" onclick="commonCheckSubmit('huidandaoruList.do?act=huidanSub','UUIDS','请选择要导入的回单')"/>
			    	<!-- <html:button property="btnSave" value="电子单下发" styleClass="commonButton4" onclick="commonCheckSubmit('huidandaoruList.do?act=gotoRadiusWangluo','UUID','请选择要导入的回单')"/> -->
			    </div>
			</div>
		</html:form>
	</div>
