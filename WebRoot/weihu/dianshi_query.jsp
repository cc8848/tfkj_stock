	...
	<div style="height:440px;">
		<html:form action="shichangList.do">
						...
						<table border="0" cellspacing="0" cellpadding="1" width="100%">
							...
							<logic:iterate id="line"
								...
								<tr align="center">
									...
									<td class="tableContentLine" nowrap="nowrap">
										<bean:write name="line" field="shichangLeibie" />
									</td>
									<td class="tableContentLine" nowrap="nowrap">
										<bean:write name="line" field="yewuLeibie" />
									</td>
									<td class="tableContentLine" nowrap="nowrap">
				...
				<div id="buttonC"  class="content_button" style="display: none" >
				  ...
				  <html:button property="btnSave" value="新增" styleClass="commonButton2" onclick="commonSubmit('dianshiEdit.do?act=insert')"/>
				  <html:button property="btnSave" value="编辑" styleClass="commonButton2" onclick="commonCheckSubmit('dianshiEdit.do?act=edit','UUID','请选择要编辑的时长类型！')"/>
