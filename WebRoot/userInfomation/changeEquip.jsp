...
<html  xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="init()">
		<html:form action="changeEquipList.do">
				...
				<div id="conten_query">
					...
					<table id="quert_table" cellpadding="1" cellspacing="1" border="0">
						<tr>
							...
							<td align="right">
								<input type="button" value="查询" class="commonButton" onclick="commonSubmit('changeEquipList.do?act=query')" />
							</td>
						</tr>
					</table>
				</div>
			...
			<div name="button" class="content_button">
				<html:button property="btnSave" value="更换设备" styleClass="commonButton2" onclick="removeDatas()"/>
				<html:button property="btnSave" value="返回" styleClass="commonButton" onclick="commonSubmit('userInfomactonList.do?act=init')"/>
			</div>
	...
	function removeDatas(){
		if(checkSelect("eqpUUID","请选择待更换的设备")){
			confirmRemove();
		}
	}
	//
	function confirmRemove(){
		showConfirm('确定要更换设备',removeCallback);
	}
	//
